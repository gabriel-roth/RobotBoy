...
std::vector<float> CollectDelayTimes(Proc& proc, const EchosParameters& params,
...
float MeasureProcessorRatio(Proc& proc, const EchosParameters& params, float in_freq,
