/**
 * test_wasp_filter.cpp — Behavioral tests for src/yellowjacket/WaspFilter.hpp
 *
 ...
 *
 * Golden numbers are the committed values in tests/yellowjacket_ref/golden.json
...
#include "../../src/yellowjacket/WaspFilter.hpp"
#include <cmath>
#include <cstdio>
#include <vector>
...
// ── Golden values (tests/yellowjacket_ref/golden.json, committed) ──────────
namespace golden {
