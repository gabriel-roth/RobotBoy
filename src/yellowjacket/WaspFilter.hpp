...
//   docs/superpowers/specs/2026-07-15-yellowjacket-dsp-design.md
// Fitted constants (authoritative): tests/yellowjacket_ref/fitted_constants.md
// Behavioral golden reference:       tests/yellowjacket_ref/wasp_ref.py
//
