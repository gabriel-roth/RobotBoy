...
// SmartCore cores; MF-20/Onbetap/Particules/Ondes by the VCV adapter. This one
// function registers all six so the same code path works whether it is called by
