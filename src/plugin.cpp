...
// built-in build enter through init_Foobar). Loooop/Löp are provided by native
...
// init_Foobar dispatch (built-in). The VCV Model* modelLoooop/modelLop are not
