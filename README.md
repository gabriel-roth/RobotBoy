...
|--------|------------|------|
| **Loooop** | A stereo RAM looper with four independent playheads. | [Loooop.md](Loooop.md) |
| **Löp** | The single-playhead version of Loooop. | [Loooop.md](Loooop.md#löp) |
| **MF-20** | Korg MS-20 filter emulation (OTA and Korg35 revisions). | [MF20.md](MF20.md) |
| **Particules** | A granular texture processor based on Mutable Instruments Beads. | [Particules.md](Particules.md) |
